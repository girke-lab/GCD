...
///////////////////////  query stuff  //////////////////////////////////////////    
    private String clusterQuery(String id,int currentDB)
    {
        ...
        query=new String("SELECT DISTINCT Clusters.Cluster_id, Sequences.Primary_Key, Sequences.Description "+
                         "FROM Clusters, Cluster_Info, Sequences "+
                         "WHERE Clusters.cluster_id=Cluster_info.cluster_id AND Sequences.seq_id=Clusters.seq_id AND "+
                         " Cluster_Info.filename='"+id+"'");
