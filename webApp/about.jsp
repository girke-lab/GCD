		...
		<li type=I><b>Search Functions</b></li><p>
                        <dl>
                                ...
                                Database searches can be performed against the following five field categories:					
                                        <ol>
                                                <li>Functional descriptions (<i>e.g.</i> '<a href="http://138.23.191.152:8080/databaseWeb/index.jsp?fieldName=Description&limit=0&input=desaturase%20AND%20fatty%20acid">desaturase AND fatty acid</a>'). Boolean query connectors can be included here: 'AND' &nbsp; 'OR' &nbsp; 'NOT'. </li>
                                ...
                                <p>
                                <dt><b><a href="http://138.23.191.152:8080/databaseWeb/advancedSearch.jsp">Advanced Searches</a></b></dt>
                                <dd>
                                ...
                                <dd>
                                        <ol>
                                                ...
                                                <ul>
                                                        ...
                                                        <li><i>O. sativa spp. japonica</i>: <a href="ftp://ftp.tigr.org/pub/data/Eukaryotic_Projects/o_sativa/annotation_dbs/pseudomolecules/version_2.0/all_chrs/">all.pep</a></li>
                                                </ul>
                                                ...
                                                <ul>
                                                        ...
                                                        <li><i>O. sativa spp. japonica</i>: <a href="ftp://ftp.tigr.org/pub/data/Eukaryotic_Projects/o_sativa/annotation_dbs/pseudomolecules/version_2.0">*.xml</a></li>
                                                </ul>
