...
<html>
    ...
    <body>
		...
		<li type=I><b>Search Functions</b></li><p>
                        <dl>
                                <a name="search"></a>
                                <dt><b><a href="http://bioweb.ucr.edu:8180/databaseWeb/index.jsp">Basic Searches in Single or Batch Mode</a></b></dt>
                                <dd>

                                Database searches can be performed against the following five field categories:					
                                        <ol>
                                                <li>Functional descriptions (<i>e.g.</i> '<a href="http://bioweb.ucr.edu:8180/databaseWeb/index.jsp?fieldName=Description&limit=0&input=desaturase%20AND%20fatty%20acid">desaturase AND fatty acid</a>'). Boolean query connectors can be included here: 'AND' &nbsp; 'OR' &nbsp; 'NOT'. </li>
                                                <li>Cluster names (<i>e.g.</i> '<a href="http://bioweb.ucr.edu:8180/databaseWeb/index.jsp?fieldName=Cluster%20Name&limit=0&input=oxidoreductase%20activity">oxidoreductase activity</a>)'</li>

                                                <li>One or many locus IDs from Arabidopsis or rice (<i>e.g.</i> '<a href="http://bioweb.ucr.edu:8180/databaseWeb/index.jsp?fieldName=Id%20Id&limit=0&input=At1g01190%20At3g62720%209631.m01858">At1g01190 &nbsp; At3g62720 &nbsp; 9631.m01858</a>')</li> 
                                                <li>Cluster or Pfam ID numbers (<i>e.g.</i> '<a href="http://bioweb.ucr.edu:8180/databaseWeb/index.jsp?fieldName=Cluster%20Id&limit=0&input=53">53</a>' or '<a href="http://bioweb.ucr.edu:8180/databaseWeb/index.jsp?fieldName=Cluster%20Id&limit=0&input=PF00067">PF00067</a>')</li>

                                                <li>Gene Ontology keys (<i>e.g.</i> '<a href="http://bioweb.ucr.edu:8180/databaseWeb/index.jsp?fieldName=GO%20Number&limit=0&input=GO:0019825">GO:0019825</a>')</li>
                                        </ol>
                                ...
                                <p>
                                <dt><b><a href="http://bioweb.ucr.edu:8180/databaseWeb/advancedSearch.jsp">Advanced Searches</a></b></dt>
                                <dd>
                ...
                <li type=I><b>Cluster Statistics Page</b></li><p>
                        <dl>
                                <dd>
                                A <a href="http://bioinfo.ucr.edu/cgi-bin/clusterStats.pl">Cluster Statistics Page</a> has been implemented to summarize and track the cluster results of the two species. It provides the size and number of singlet and family proteins for the two clustering methods.   
                                </dd>
