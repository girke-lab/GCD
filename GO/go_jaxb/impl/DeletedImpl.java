...
public class DeletedImpl
    extends GO.go_jaxb.impl.DeletedTypeImpl
    implements GO.go_jaxb.Deleted, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, GO.go_jaxb.impl.runtime.UnmarshallableObject, GO.go_jaxb.impl.runtime.XMLSerializable, GO.go_jaxb.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (GO.go_jaxb.Deleted.class);
    }
    ...
    public GO.go_jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(GO.go_jaxb.impl.runtime.UnmarshallingContext context) {
        return new GO.go_jaxb.impl.DeletedImpl.Unmarshaller(context);
    }
...
+"Reducibilityt\u0000\u0013Ljava/lang/Boolean;L\u0000\u000bexpandedExpq\u0000~\u0000\u0003xp\u0002$n7p"
...
+"\u0000\u0000\u0000\tsq\u0000~\u0000\f\u0001psq\u0000~\u0000\"t\u0000\u0007deletedt\u0000\u0000sr\u0000\"com.sun.msv.grammar.Expre"
...
+"p"));
        ...
        extends GO.go_jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return GO.go_jaxb.impl.DeletedImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  0 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromEnterElement((((GO.go_jaxb.impl.DeletedTypeImpl)GO.go_jaxb.impl.DeletedImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    ...
                    case  2 :
                        ...
                        break;
                    case  1 :
                        spawnHandlerFromLeaveElement((((GO.go_jaxb.impl.DeletedTypeImpl)GO.go_jaxb.impl.DeletedImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromEnterAttribute((((GO.go_jaxb.impl.DeletedTypeImpl)GO.go_jaxb.impl.DeletedImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  1 :
                        spawnHandlerFromLeaveAttribute((((GO.go_jaxb.impl.DeletedTypeImpl)GO.go_jaxb.impl.DeletedImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname);
                        return ;
                }
                ...
                try {
                    switch (state) {
                        case  3 :
                            ...
                            return ;
                        case  1 :
                            spawnHandlerFromText((((GO.go_jaxb.impl.DeletedTypeImpl)GO.go_jaxb.impl.DeletedImpl.this).new Unmarshaller(context)), 2, value);
                            return ;
                    }
