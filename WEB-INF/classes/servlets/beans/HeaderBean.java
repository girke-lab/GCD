...
public class HeaderBean
{
    ...
    public enum HeaderType {GCD,POND,COMMON};
    ...
    public void printSystomicsHeader()
    {
        ...
        out.println(
            "<table class=head cellSpacing=0 cellPadding=1 width='100%' bgColor=#ffffff border=0><tbody>" +
                ...
                "          </tr>" +                
                "	   <tr> <td valign=center align=center height=15 bgColor=#6D7B8D><b><i><font size=5 color='#000000'>"+title+"</font></i></b></td>" +
                "          </tr>" +
    ...
    public void printUnknownsHeader()
    {
        ...
        out.println(                
            ...
            "			<tr><td class=foot bgColor=#c0c0c0><a href='./index.html'><IMG height=7 src='./images/bullet.gif' width=4 border=0 alt='Home'></a> " +
