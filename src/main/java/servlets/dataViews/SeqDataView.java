...
//////////////////////////////////////////////////////////////////////    
    ...
    class SeqRecord
    {
        ...
        {            
            ...
            out.println("<TR><TD><A href='http://"+servlets.Common.hostname+"/scripts/seqview.pl?database=all&accession="+key+"'>"+key+"</A>");
            if(v3Key!=null)
...
//                     }                 
                 ...
                 {
                    String webBase="http://"+servlets.Common.hostname+"/scripts/getClusterFiles.pl?cid="+cs.clusterNum+ 
                         "&cluster_type="+cs.method+"&file_type=";

                    out.println("\t\t<TD nowrap>");
                    out.println("\t\t\t<a href='"+webBase+"html'>Consensus shaded</a>&nbsp&nbsp");
                    out.println("\t\t\t<a href='http://"+servlets.Common.hostname+"/scripts/domainShader?cid="+cs.clusterNum+"'>Domain shaded</a>");
                    out.println("\t\t</TD>");
        ...
        {//size is cluster size
             ...
             out.println("<a href='http://"+servlets.Common.hostname+"/scripts/geneview.pl?accession="+key+"'>GeneStructure*</a>&nbsp&nbsp");
